...
import omega from "../utils/questionary.js";
import alfa from "../utils/constants.js";
import {
  Avatar,
  ContainerCover,
  ContainerOrganized,
  ...
  Title,
  UnOrganizedButton,
} from "../styleComponents/styleQuestion";
import { getUserInfo } from "../helpers/userInfo.js";
import axios from "axios";
import Cleaner from "../helpers/Cleaner.js";
import { set } from "../utils/time.js";
const { RESPONSE, ADD, REMOVE } = alfa;
...
class Question {
  constructor(category) {
    ...
    this.responses = [];
    this.baseUrl = "https://dayli-bit-ao.herokuapp.com";
  ...
  find() {
    let questions =
      ...
      omega.filter((question) => question.category === this.category);
    return questions;
  }
